...
function fSetBestContact() {
    ...
    var WorkPhone = document.getElementById('WorkPhoneTextBox').value;
    var CellPhone = document.getElementById('CellPhoneTextBox').value;
    var dropDown = document.getElementById('person_cell_phone');
...
function fCheckBestContact() {
    ...
    if (dropDownValue == 'Home' && HomePhone == '') {
        ...
        document.getElementById('HomePhoneTextBox').focus();
    }
    else if (dropDownValue == 'Work' && WorkPhone == '') {
        alert('No work phone number has been entered.');
        document.getElementById('WorkPhoneTextBox').focus();
    }
